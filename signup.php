<?php 
  ...
  if(empty($_POST['sellercity'])){
    $city_error="<p class='text-danger' style='position:absolute'>Please enter mobile !<p/>";
  }
  if(empty($_POST['sellerpincode'])){
    $pincode_error="<p class='text-danger' style='position:absolute'>Please enter email !<p/>";
  }
  if(empty($_POST['sellercity'])){
    $city_error="<p class='text-danger' style='position:absolute'>Please enter mobile !<p/>";
  }
  ...
  <html lang="en">
    ...
    <body>
        ...
        <div class="cardseller mx-auto">
          <h1 class="mx-auto">SignUp</h1>
    ...
    <div class="main">     
        ...
        <label for="">Name</label><br>
                ...
                <input  class="form-control" type="text" placeholder="enter your mobile" name="sellermobile">
                <span><?php echo $city_error ?></span>
              </div>
                <br>
                <div class="eachdiv"><label for="">Email</label><br>
                <input  class="form-control" type="mail" placeholder="enter email" name="selleremail">
            ...
            <div class="right">
              ...
              <div class="eachdiv">
                  <label for="">City</label><br>
                    <input  class="form-control" type="text" placeholder="enter your city" name="sellerecity">
